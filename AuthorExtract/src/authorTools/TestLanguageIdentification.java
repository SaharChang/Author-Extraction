...
public class TestLanguageIdentification {
	...
	public static void Test() {
		...
		System.out.println(li.DetectLanguage(strTest));
		// Assert.Condition(li.DetectLanguage(strTest).equals(Balie.
		// LANGUAGE_FRENCH), "Language Identification Fails.");
		...
		System.out.println(li.DetectLanguage(strTest));
		// Assert.Condition(li.DetectLanguage(strTest).equals(Balie.
		// LANGUAGE_SPANISH), "Language Identification Fails.");
		...
		System.out.println(li.DetectLanguage(strTest));
		// Assert.Condition(li.DetectLanguage(strTest).equals(Balie.
		// LANGUAGE_GERMAN), "Language Identification Fails.");
		...
		System.out.println(li.DetectLanguage(strTest));
		// Assert.Condition(li.DetectLanguage(strTest).equals(Balie.
		// LANGUAGE_ROMANIAN), "Language Identification Fails.");
