...
public class YahooWebSearcher extends AbstractSearcher {
	public YahooWebSearcher() {

	}

	public YahooWebSearcher(String appID) {
        setAppKey(appID);		
	}			
	...
	public Iterator<SearchResult> search(String query) {
		...
		return new WebSearchIterator(getAppKey(), getQueryParser().parse(query));
	}
